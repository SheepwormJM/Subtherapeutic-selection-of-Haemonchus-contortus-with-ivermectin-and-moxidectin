Using the 57X subsampled mpileup file. You can find how this was made in the Mpileup folder.
```
...
ggsave("EmergingMLR_manuscript_Fig3_light_titles_positionalindex_withromannumerals_UPDATED080925_LEGENDBOTTOM.tiff", plotme, device=tiff, width=2250, height=2250, units="px", dpi=320)
```
_Plot used in paper with roman numerals for chromosomes:_
<img width="2250" height="2250" alt="image" src="https://github.com/user-attachments/assets/efcf5457-00a5-406d-a3d6-b654b2dd4468" />
