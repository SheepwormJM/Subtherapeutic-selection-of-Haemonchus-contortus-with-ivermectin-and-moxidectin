...
# F0:F1_IVM1 etc:
win_melt_F1$variable.new<-gsub("C_L","CTL", win_melt_F1$variable.new)
win_melt_F1$variable.new<-gsub("I_L","IVM", win_melt_F1$variable.new)
win_melt_F1$variable.new<-gsub("M_L","MOX", win_melt_F1$variable.new)
win_melt_F1$variable.new<-gsub("\\.",":", win_melt_F1$variable.new)

win_melt_F2$variable<-gsub("C_L","CTL", win_melt_F2$variable)
win_melt_F2$variable<-gsub("I_L","IVM", win_melt_F2$variable)
win_melt_F2$variable<-gsub("M_L","MOX", win_melt_F2$variable)
win_melt_F2$variable<-gsub("\\.",":", win_melt_F2$variable)

win_melt_F3.F0$variable<-gsub("C_L","CTL", win_melt_F3.F0$variable)
win_melt_F3.F0$variable<-gsub("I_L","IVM", win_melt_F3.F0$variable)
win_melt_F3.F0$variable<-gsub("M_L","MOX", win_melt_F3.F0$variable)
win_melt_F3.F0$variable<-gsub("\\.",":", win_melt_F3.F0$variable)

win_melt_selpwc$variable<-gsub("M_L","MOX", win_melt_selpwc$variable)
win_melt_selpwc$variable<-gsub("I_L","IVM", win_melt_selpwc$variable)
win_melt_selpwc$variable<-gsub("\\.",":", win_melt_selpwc$variable)
...
# Just C1 etc:
win_melt_F1$variable.new<-gsub("C_L","C", win_melt_F1$variable.new)
win_melt_F1$variable.new<-gsub("I_L","I", win_melt_F1$variable.new)
win_melt_F1$variable.new<-gsub("M_L","M", win_melt_F1$variable.new)
win_melt_F1$variable.new<-gsub("\\.",":", win_melt_F1$variable.new)

win_melt_F2$variable<-gsub("C_L","C", win_melt_F2$variable)
win_melt_F2$variable<-gsub("I_L","I", win_melt_F2$variable)
win_melt_F2$variable<-gsub("M_L","M", win_melt_F2$variable)
win_melt_F2$variable<-gsub("\\.",":", win_melt_F2$variable)

win_melt_F3.F0$variable<-gsub("C_L","C", win_melt_F3.F0$variable)
win_melt_F3.F0$variable<-gsub("I_L","I", win_melt_F3.F0$variable)
win_melt_F3.F0$variable<-gsub("M_L","M", win_melt_F3.F0$variable)
win_melt_F3.F0$variable<-gsub("\\.",":", win_melt_F3.F0$variable)

win_melt_selpwc$variable<-gsub("M_L","M", win_melt_selpwc$variable)
win_melt_selpwc$variable<-gsub("I_L","I", win_melt_selpwc$variable)
win_melt_selpwc$variable<-gsub("\\.",":", win_melt_selpwc$variable)
```

## Theme_light, no legend, use grid instead
Note, needed to reduce the text size etc to fit the tiff output file requirement sizes for PLOS Path. 
```
R
...
ggsave("EmergingMLR_manuscript_Fig3_light.tiff", plotme, device=tiff, width=2250, height=2250, units="px", dpi=320)
```
![image](https://github.com/user-attachments/assets/d47dc6ab-f781-426d-9c69-8fc33d8d42da)
...
geom_point(aes(colour=chrom), alpha=0.3, size=0.3) +
labs(y="Genetic differentiation (10kb window Fst)", x="Genomic position (Mb)")+
geom_hline(data = filter(win_melt_F1,variable.new==c("F0:F1_IVM1","F0:F1_IVM2", "F0:F1_IVM3")), aes(yintercept = 0.1840843), linetype = "dashed", linewidth = 0.3, colour = "black") +
geom_hline(data = filter(win_melt_F1,variable.new==c("F0:F1_MOX1","F0:F1_MOX2", "F0:F1_MOX3")), aes(yintercept = 0.2144305), linetype = "dotted", linewidth = 0.3, colour = "black") +
theme_light()+
theme(axis.title.x = element_text(size=10), axis.text.x = element_text(size=6), axis.title.y = element_text(size=10), axis.text.y = element_text(size=6), strip.text.x = element_text(size = 6, face = "bold", margin = margin(0.5,0,0.5,0, "mm")), strip.text.y = element_text(size = 6, face = "bold", angle=0), plot.title = element_blank(), legend.position = "none", panel.spacing.x = unit(0.2, "mm"), panel.spacing.y = unit(0.75, "mm"))+
facet_grid(variable.new~chrom, scales = "free_x", switch="x")+
guides(alpha = "none", colour = "none") +
...
geom_point(aes(colour=chrom), alpha=0.3, size=0.3) +
labs(y="Genetic differentiation (10kb window Fst)", x="Genomic position (Mb)")+
geom_hline(data = filter(win_melt_F2, variable==c("F0:F2_IVM1","F0:F2_IVM2", "F0:F2_IVM3")), aes(yintercept = 0.1840843), linetype = "dashed", linewidth = 0.3, colour = "black") +
geom_hline(data = filter(win_melt_F2, variable==c("F0:F2_MOX1","F0:F2_MOX2", "F0:F2_MOX3")), aes(yintercept = 0.2144305), linetype = "dotted", linewidth = 0.3, colour = "black") +
theme_light()+
theme(axis.title.x = element_text(size=10), axis.text.x = element_text(size=6), axis.title.y = element_text(size=10), axis.text.y = element_text(size=6), strip.text.x = element_text(size = 6, face = "bold", margin = margin(0.5,0,0.5,0, "mm")), strip.text.y = element_text(size = 6, face = "bold", angle=0), plot.title = element_blank(), legend.position = "none", panel.spacing.x = unit(0.2, "mm"), panel.spacing.y = unit(0.75, "mm"))+
facet_grid(variable~chrom, scales = "free_x", switch="x")+
guides(alpha = "none", colour = "none") +
...
geom_point(aes(colour=chrom), alpha=0.3, size=0.3) +
labs(y="Genetic differentiation (10kb window Fst)", x="Genomic position (Mb)")+
geom_hline(data = filter(win_melt_F3.F0, variable==c("F0:F3_IVM1","F0:F3_IVM2", "F0:F3_IVM3")), aes(yintercept = 0.1840843), linetype = "dashed", linewidth = 0.3, colour = "black") +
geom_hline(data = filter(win_melt_F3.F0, variable==c("F0:F3_MOX1","F0:F3_MOX2", "F0:F3_MOX3")), aes(yintercept = 0.2144305), linetype = "dotted", linewidth = 0.3, colour = "black") +
theme_light()+
theme(axis.title.x = element_text(size=10), axis.text.x = element_text(size=6), axis.title.y = element_text(size=10), axis.text.y = element_text(size=6), strip.text.x = element_text(size = 6, face = "bold", margin = margin(0.5,0,0.5,0, "mm")), strip.text.y = element_text(size = 6, face = "bold", angle=0), plot.title = element_blank(), legend.position = "none", panel.spacing.x = unit(0.2, "mm"), panel.spacing.y = unit(0.75, "mm"))+
facet_grid(variable~chrom, scales = "free_x", switch="x") +
guides(colour = guide_legend(override.aes = list(alpha = 1, size=1.5), title = "Chromosome", legend.text.position = "left",  legend.title.position = "right", nrow = 1, legend.text = element_text(size=6), legend.title = element_text(size = 8))) +
...
ggsave("EmergingMLR_manuscript_Fig3_light.tiff", plotme, device=tiff, width=2250, height=2250, units="px", dpi=320)
```
![image](https://github.com/user-attachments/assets/8555fa74-22ee-4f38-be37-3c77c893df1b)
...
geom_point(aes(colour=chrom), alpha=0.3, size=0.3) +
labs(y="Genetic differentiation (10kb window Fst)", x="Genomic position (Mb)")+
geom_hline(data = filter(win_melt_F1,variable.new==c("F0:F1_I1","F0:F1_I2", "F0:F1_I3")), aes(yintercept = 0.1840843), linetype = "dashed", linewidth = 0.3, colour = "black") +
geom_hline(data = filter(win_melt_F1,variable.new==c("F0:F1_M1","F0:F1_M2", "F0:F1_M3")), aes(yintercept = 0.2144305), linetype = "dotted", linewidth = 0.3, colour = "black") +
theme_light()+
theme(axis.title.x = element_text(size=10), axis.text.x = element_text(size=6), axis.title.y = element_text(size=10), axis.text.y = element_text(size=6), strip.text.x = element_text(size = 6, face = "bold", margin = margin(0.5,0,0.5,0, "mm")), strip.text.y = element_text(size = 6, face = "bold", angle=0), plot.title = element_blank(), legend.position = "none", panel.spacing.x = unit(0.2, "mm"), panel.spacing.y = unit(0.75, "mm"))+
facet_grid(variable.new~chrom, scales = "free_x", switch="x")+
guides(alpha = "none", colour = "none") +
...
geom_point(aes(colour=chrom), alpha=0.3, size=0.3) +
labs(y="Genetic differentiation (10kb window Fst)", x="Genomic position (Mb)")+
geom_hline(data = filter(win_melt_F2, variable==c("F0:F2_I1","F0:F2_I2", "F0:F2_I3")), aes(yintercept = 0.1840843), linetype = "dashed", linewidth = 0.3, colour = "black") +
geom_hline(data = filter(win_melt_F2, variable==c("F0:F2_M1","F0:F2_M2", "F0:F2_M3")), aes(yintercept = 0.2144305), linetype = "dotted", linewidth = 0.3, colour = "black") +
theme_light()+
theme(axis.title.x = element_text(size=10), axis.text.x = element_text(size=6), axis.title.y = element_text(size=10), axis.text.y = element_text(size=6), strip.text.x = element_text(size = 6, face = "bold", margin = margin(0.5,0,0.5,0, "mm")), strip.text.y = element_text(size = 6, face = "bold", angle=0), plot.title = element_blank(), legend.position = "none", panel.spacing.x = unit(0.2, "mm"), panel.spacing.y = unit(0.75, "mm"))+
facet_grid(variable~chrom, scales = "free_x", switch="x")+
guides(alpha = "none", colour = "none") +
...
geom_point(aes(colour=chrom), alpha=0.3, size=0.3) +
labs(y="Genetic differentiation (10kb window Fst)", x="Genomic position (Mb)")+
geom_hline(data = filter(win_melt_F3.F0, variable==c("F0:F3_I1","F0:F3_IVM2", "F0:F3_I3")), aes(yintercept = 0.1840843), linetype = "dashed", linewidth = 0.3, colour = "black") +
geom_hline(data = filter(win_melt_F3.F0, variable==c("F0:F3_M1","F0:F3_M2", "F0:F3_M3")), aes(yintercept = 0.2144305), linetype = "dotted", linewidth = 0.3, colour = "black") +
theme_light()+
theme(axis.title.x = element_text(size=10), axis.text.x = element_text(size=6), axis.title.y = element_text(size=10), axis.text.y = element_text(size=6), strip.text.x = element_text(size = 6, face = "bold", margin = margin(0.5,0,0.5,0, "mm")), strip.text.y = element_text(size = 6, face = "bold", angle=0), plot.title = element_blank(), legend.position = "none", panel.spacing.x = unit(0.2, "mm"), panel.spacing.y = unit(0.75, "mm"))+
facet_grid(variable~chrom, scales = "free_x", switch="x") +
guides(colour = guide_legend(override.aes = list(alpha = 1, size=1.5), title = "Chromosome", legend.text.position = "left",  legend.title.position = "right", nrow = 1, legend.text = element_text(size=6), legend.title = element_text(size = 8))) +
...
ggsave("EmergingMLR_manuscript_Fig3_light.tiff", plotme, device=tiff, width=2250, height=2250, units="px", dpi=320)
```
![image](https://github.com/user-attachments/assets/9fdb5e29-1a9b-43ea-9eed-339342e22645)
